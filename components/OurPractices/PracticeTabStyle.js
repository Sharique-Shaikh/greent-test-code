...
export const GreenTernWrapper = styled.div`
  background-image: url('/assets/images/WhyGTBg.svg');
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
`;

export const PracticeTabWrapper = styled.div`
  margin-top: 5rem;
...
export const Tabs = styled.div`
  ...
  background-color: ${(props) =>
    props?.tabSelect ? props.theme.BurntSienna : ''};
